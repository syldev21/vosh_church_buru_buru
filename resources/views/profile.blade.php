                            ...
                            <div class="col-lg-8 px-5">
                                <form action="#" method="POST" id="profile_form">
                                    ...
                                    <div class="my-2">
                                        ...
                                        <input type="text" name="name" class="form-control rounded-0" id="name" value="{{$userInfo->name}}">
                                    </div>
                                    <div class="my-2">
                                        <label for="name">Email</label>
                                        <input type="email" name="email" class="form-control rounded-0" id="email" value="{{$userInfo->email}}">
                                    </div>
                                    <div class="row">
                                        <div class="col-lg">
                                        ...
                                        <div class="col-lg">
                                            ...
                                            <input type="date" for="dob" name="dob" class="form-control rounded-0" id="dob" value="{{$userInfo->dob}}">
                                        </div>
                                    </div>
                                    <div class="my-2">
                                    ...
                                    <div class="my-2">
                                        <input type="submit" class="btn btn-primary rounded-0 float-end" value="Update Profile" id="profile_btn">
                                    </div>
                                </form>
                            </div>
                        </div>
